    ...
    if request.method == 'POST':
        if form.validate():
            ...
            if existing_user is None:
                ...
                form.email.errors.append("This user is registered in our app, please proceed to log in")
        ...
        if form.validate():
            ...
            if check_user:
                if check_password_hash(check_user['password'], form.password.data):
                    ...
                    form.password.errors.append("You have entered wrong password")
            else:
                form.email.errors.append("This user is not registered in our app, please proceed to register")
